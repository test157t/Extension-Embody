...
[Intiface Launcher] Serving static files from:
  /assets/intiface/media -> D:\Github\SillyTavern\data\default-user\assets\intiface\media
  /assets/intiface/funscript -> D:\Github\SillyTavern\data\default-user\assets\intiface\funscript
  /assets/intiface/playmodes -> D:\Github\SillyTavern\data\default-user\assets\intiface\playmodes
```
...
1. **Prepare your files:**
   - Place video files in: `SillyTavern/data/default-user/assets/intiface/media/`
